...
-- Generated from ug_payment_mode_plan.csv (536 rows: 535 online, 1 coupon).

-- ============================================================
-- 1. THE ROWS THAT WILL CHANGE.  Expect exactly 536 rows.
...
-- ============================================================
-- 2. SUMMARY of the same set.  Expect: online 535, coupon 1
--    and blank_now = 536, already_has_mode = 0.
-- ============================================================
WITH plan(lead_id, new_mode) AS (VALUES
  (683682,'online'),
  (683703,'online'),
...
--    total_blank must equal 536 - i.e. the plan covers all of them and
